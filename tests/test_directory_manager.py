...
class TestDirectoryManager():
    ...
    def test_check_if_dir_exists(self):
        ...
        assert DirectoryManager.check_if_dir_exists(self.non_exist_test_folder_path) == False

    def test_create_dir_if_not_exists(self):
        DirectoryManager.create_dir_if_not_exists(self.non_exist_test_folder_path)
        assert DirectoryManager.check_if_dir_exists(self.non_exist_test_folder_path) == True
